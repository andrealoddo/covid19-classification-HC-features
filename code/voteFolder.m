...
myDirFeatures = 'D:\Tesi\covid19-classification-HC-features\code\FromImageToBestClassifier\ComputedFeatures'; %gets directory
...
mA=table2array(modifiedTable);
    fileID = fopen('testCNNHCEnsembleOfBoosted.txt','a');
